...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('../admin/images/logos/favicon.png') ?>">
    <title>
        <?= $title ?>
    </title>
        ...
        <aside class="left-sidebar">
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="<?= base_url('urself') ?>" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
                        <h4 class="m-0 text-secondary"><img src="<?= base_url("../admin/images/logos/favicon.png") ?>"
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('urself') ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('urself/users') ?>" aria-expanded="false">
                                <span>
                                    <iconify-icon icon="raphael:users" width="20" height="20"></iconify-icon>
                                </span>
                                <span class="hide-menu">Users</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('urself/report') ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('urself/about-us') ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= base_url('urself/contact') ?>" aria-expanded="false">
                                <span>
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="<?= base_url("../admin/images/profile/user-1.jpg") ?>" alt="" width="35"
